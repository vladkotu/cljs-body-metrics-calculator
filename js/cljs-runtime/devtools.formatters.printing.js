...
var len__4730__auto___51028 = arguments.length;
var i__4731__auto___51029 = (0);
while(true){
if((i__4731__auto___51029 < len__4730__auto___51028)){
args__4736__auto__.push((arguments[i__4731__auto___51029]));

var G__51030 = (i__4731__auto___51029 + (1));
i__4731__auto___51029 = G__51030;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50978){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50979,G__50980,seq50978__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50993_SHARP_){
return (!((cljs.core.meta(p1__50993_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51008__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e51012){var _e__49097__auto__ = e51012;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e51014){var _e__49097__auto__ = e51014;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__51016 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__51017 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__51017;

try{var map__51018 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51018__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__51016;
}});
...
;
var temp__5733__auto___51035 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___51035)){
var managed_print_level_51036 = temp__5733__auto___51035;
var _STAR_print_level_STAR__orig_val__51024_51037 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__51025_51038 = managed_print_level_51036;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__51025_51038;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__51024_51037,_STAR_print_level_STAR__temp_val__51025_51038,managed_print_level_51036,temp__5733__auto___51035,writer,opts,job_fn){
return (function (p1__51023_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__51023_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__51024_51037,_STAR_print_level_STAR__temp_val__51025_51038,managed_print_level_51036,temp__5733__auto___51035,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__51024_51037;
}} else {
job_fn();
}
