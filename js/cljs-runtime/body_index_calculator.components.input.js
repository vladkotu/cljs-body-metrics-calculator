...
body_index_calculator.components.input.shared_input = (function body_index_calculator$components$input$shared_input(p__69478){
...
var units = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69479__$1,new cljs.core.Keyword(null,"units","units",-533089095));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69479__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__69479,map__69479__$1,units){
return (function (){
return cljs.core.List.EMPTY;
});})(map__69479,map__69479__$1,units))
);
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69479__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624),((function (map__69479,map__69479__$1,units,on_change){
return (function (){
return cljs.core.List.EMPTY;
});})(map__69479,map__69479__$1,units,on_change))
);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69479__$1,new cljs.core.Keyword(null,"value","value",305978217));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69479__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747),((function (map__69479,map__69479__$1,units,on_change,on_focus,value){
return (function (){
return cljs.core.List.EMPTY;
});})(map__69479,map__69479__$1,units,on_change,on_focus,value))
);
var input_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69479__$1,new cljs.core.Keyword(null,"input-style","input-style",-374295278));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69479__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69479__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var error_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69479__$1,new cljs.core.Keyword(null,"error-text","error-text",2021893718));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69479__$1,new cljs.core.Keyword(null,"error","error",-978969032));
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$core$FormControl$index.default,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"error","error",-978969032),error,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),"100%",new cljs.core.Keyword(null,"position","position",-2011731912),"initial"], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$core$InputLabel$index.default,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"html-for","html-for",594503920),id,new cljs.core.Keyword(null,"variant","variant",-424354234),"filled"], null),label], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$core$FilledInput$index.default,new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"type","type",1174270348),"tel",new cljs.core.Keyword(null,"value","value",305978217),(function (){var or__4131__auto__ = value;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return "";
}
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__69479,map__69479__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error){
return (function (p1__69477_SHARP_){
var G__69487 = body_index_calculator.helpers.evalue(p1__69477_SHARP_);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__69487) : on_change.call(null,G__69487));
});})(map__69479,map__69479__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error))
,new cljs.core.Keyword(null,"on-blur","on-blur",814300747),((function (map__69479,map__69479__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error){
return (function (){
return (on_blur.cljs$core$IFn$_invoke$arity$0 ? on_blur.cljs$core$IFn$_invoke$arity$0() : on_blur.call(null));
});})(map__69479,map__69479__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error))
,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624),((function (map__69479,map__69479__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error){
return (function (){
...
var with_let69493 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let69493","with-let69493",-605469574));
var temp__5739__auto___69521 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___69521 == null)){
} else {
var c__56559__auto___69522 = temp__5739__auto___69521;
if((with_let69493.generation === c__56559__auto___69522.ratomGeneration)){
...
with_let69493.generation = c__56559__auto___69522.ratomGeneration;
}


var init69494 = (with_let69493.length === (0));
var active = ((init69494)?(with_let69493[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((1))):(with_let69493[(0)]));
var id = ((init69494)?(with_let69493[(1)] = body_index_calculator.helpers.react_key.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["input-",label], 0))):(with_let69493[(1)]));
var reset_active = ((init69494)?(with_let69493[(2)] = ((function (init69494,active,id,with_let69493){
return (function (n){
return ((function (init69494,active,id,with_let69493){
