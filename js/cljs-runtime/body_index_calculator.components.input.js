...
body_index_calculator.components.input.shared_input = (function body_index_calculator$components$input$shared_input(p__50343){
...
var units = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50344__$1,new cljs.core.Keyword(null,"units","units",-533089095));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50344__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__50344,map__50344__$1,units){
return (function (){
return cljs.core.List.EMPTY;
});})(map__50344,map__50344__$1,units))
);
var on_focus = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50344__$1,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624),((function (map__50344,map__50344__$1,units,on_change){
return (function (){
return cljs.core.List.EMPTY;
});})(map__50344,map__50344__$1,units,on_change))
);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50344__$1,new cljs.core.Keyword(null,"value","value",305978217));
var on_blur = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50344__$1,new cljs.core.Keyword(null,"on-blur","on-blur",814300747),((function (map__50344,map__50344__$1,units,on_change,on_focus,value){
return (function (){
return cljs.core.List.EMPTY;
});})(map__50344,map__50344__$1,units,on_change,on_focus,value))
);
var input_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50344__$1,new cljs.core.Keyword(null,"input-style","input-style",-374295278));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50344__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50344__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var error_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50344__$1,new cljs.core.Keyword(null,"error-text","error-text",2021893718));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50344__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
})(),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__50344,map__50344__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error){
return (function (p1__50342_SHARP_){
var G__50346 = body_index_calculator.helpers.evalue(p1__50342_SHARP_);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__50346) : on_change.call(null,G__50346));
});})(map__50344,map__50344__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error))
,new cljs.core.Keyword(null,"on-blur","on-blur",814300747),((function (map__50344,map__50344__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error){
return (function (){
return (on_blur.cljs$core$IFn$_invoke$arity$0 ? on_blur.cljs$core$IFn$_invoke$arity$0() : on_blur.call(null));
});})(map__50344,map__50344__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error))
,new cljs.core.Keyword(null,"on-focus","on-focus",-13737624),((function (map__50344,map__50344__$1,units,on_change,on_focus,value,on_blur,input_style,label,id,error_text,error){
return (function (){
...
var with_let50347 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let50347","with-let50347",-2137194587));
var temp__5739__auto___50350 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___50350 == null)){
} else {
var c__45709__auto___50351 = temp__5739__auto___50350;
if((with_let50347.generation === c__45709__auto___50351.ratomGeneration)){
...
with_let50347.generation = c__45709__auto___50351.ratomGeneration;
}


var init50348 = (with_let50347.length === (0));
var active = ((init50348)?(with_let50347[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((1))):(with_let50347[(0)]));
var id = ((init50348)?(with_let50347[(1)] = body_index_calculator.helpers.react_key.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["input-",label], 0))):(with_let50347[(1)]));
var reset_active = ((init50348)?(with_let50347[(2)] = ((function (init50348,active,id,with_let50347){
return (function (n){
return ((function (init50348,active,id,with_let50347){
...
;})(init50348,active,id,with_let50347))
});
;})(init50348,active,id,with_let50347))
});})(init50348,active,id,with_let50347))
):(with_let50347[(2)]));
