...
var G__50545 = devtools.prefs.pref(v);
v = G__50545;
continue;
} else {
return v;
...
}catch (e50514){var _e__48752__auto__ = e50514;
return false;
}})();
...
}catch (e50524){var _e__48752__auto__ = e50524;
return false;
}})();
...
}catch (e50526){var _e__48752__auto__ = e50526;
return false;
}}
}
});
...
var vec__50534 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50534,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50534,(1),null);
...
return cljs.core.some((function (p1__50538_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__50538_SHARP_);
}),template);
});
