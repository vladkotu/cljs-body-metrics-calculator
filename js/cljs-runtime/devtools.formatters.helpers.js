...
var G__50962 = devtools.prefs.pref(v);
v = G__50962;
continue;
} else {
return v;
...
}catch (e50925){var _e__49097__auto__ = e50925;
return false;
}})();
...
}catch (e50929){var _e__49097__auto__ = e50929;
return false;
}})();
...
}catch (e50934){var _e__49097__auto__ = e50934;
return false;
}}
}
});
...
var vec__50946 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50946,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50946,(1),null);
...
return cljs.core.some((function (p1__50949_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__50949_SHARP_);
}),template);
});
