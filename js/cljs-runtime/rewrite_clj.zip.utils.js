...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__54579,k,f){
var vec__54580 = p__54579;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54580,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54580,(1),null);
var loc = vec__54580;
...
var G__54682 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__54682;
continue;
}
break;
...
var G__54683 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__54683;
continue;
} else {
return zloc__$1;
...
var G__54712 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__54712;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__54623){
...
var path = map__54627__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54627__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__54624;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__54649){
var vec__54650 = p__54649;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54650,(0),null);
var map__54653 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54650,(1),null);
var map__54653__$1 = (((((!((map__54653 == null))))?(((((map__54653.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54653.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54653):map__54653);
var path = map__54653__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54653__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__54650;
if(cljs.core.seq(r)){
...
var vec__54669 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54669,(0),null);
var map__54672 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54669,(1),null);
...
var path = map__54672__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54672__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54672__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54672__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54672__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
