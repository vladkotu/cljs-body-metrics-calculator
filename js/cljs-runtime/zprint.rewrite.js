...
var G__55942 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__55942;
continue;
} else {
var G__55943 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__55943;
continue;
}
} else {
var G__55944 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__55944;
continue;
}
}
...
var G__55905 = zloc;
var G__55906 = (function (){var G__55907 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__55908 = zloc;
var G__55908__$1 = (((G__55908 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__55908) : rewrite_clj.zip.node.call(null,G__55908)));
if((G__55908__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__55908__$1) : zprint.zutil.edn_STAR_.call(null,G__55908__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__55907) : rewrite_clj.zip.root.call(null,G__55907));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__55905,G__55906) : rewrite_clj.zip.replace.call(null,G__55905,G__55906));
});
/**
...
var G__55947 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__55947;
continue;
}
break;
...
var G__55948 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__55949 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__55948;
out = G__55949;
continue;
} else {
...
var G__55951 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__55952 = cljs.core.next(new_loc);
var G__55953 = replaced_loc;
nloc = G__55951;
new_loc = G__55952;
last_loc = G__55953;
continue;
...
return zprint.rewrite.sort_val((function (){var G__55928 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__55928) : rewrite_clj.zip.down.call(null,G__55928));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__55932_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__55932_SHARP_) : rewrite_clj.zip.tag.call(null,p1__55932_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__55932_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__55932_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
