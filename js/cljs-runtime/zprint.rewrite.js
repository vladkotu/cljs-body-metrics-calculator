...
var G__55373 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__55373;
continue;
} else {
var G__55376 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__55376;
continue;
}
} else {
var G__55377 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__55377;
continue;
}
}
...
var G__55283 = zloc;
var G__55284 = (function (){var G__55291 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__55293 = zloc;
var G__55293__$1 = (((G__55293 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__55293) : rewrite_clj.zip.node.call(null,G__55293)));
if((G__55293__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__55293__$1) : zprint.zutil.edn_STAR_.call(null,G__55293__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__55291) : rewrite_clj.zip.root.call(null,G__55291));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__55283,G__55284) : rewrite_clj.zip.replace.call(null,G__55283,G__55284));
});
/**
...
var G__55389 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__55389;
continue;
}
break;
...
var G__55390 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__55391 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__55390;
out = G__55391;
continue;
} else {
...
var G__55403 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__55404 = cljs.core.next(new_loc);
var G__55405 = replaced_loc;
nloc = G__55403;
new_loc = G__55404;
last_loc = G__55405;
continue;
...
return zprint.rewrite.sort_val((function (){var G__55350 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__55350) : rewrite_clj.zip.down.call(null,G__55350));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__55352_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__55352_SHARP_) : rewrite_clj.zip.tag.call(null,p1__55352_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__55352_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__55352_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
