...
var vec__57090 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__57093 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57093,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57093,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57090,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57090,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__57100){
var vec__57103 = p__57100;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57103,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57103,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57106,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57106,(1),null);
...
var vec__57116 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57116,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57116,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57116,(2),null);
var vec__57119 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57119,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57119,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57119,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__57126){
var vec__57130 = p__57126;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57130,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57130,(1),null);
...
var len__4730__auto___57235 = arguments.length;
var i__4731__auto___57236 = (0);
while(true){
if((i__4731__auto___57236 < len__4730__auto___57235)){
args__4736__auto__.push((arguments[i__4731__auto___57236]));

var G__57237 = (i__4731__auto___57236 + (1));
i__4731__auto___57236 = G__57237;
continue;
} else {
}
break;
...
var vec__57138 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57138,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57138,(1),null);
...
var G__57141 = zprint.core.parse_string_all_options(rest_options);
var G__57142 = zprint.core.czprint_str_internal;
var G__57143 = ":parse-string-all? call";
var G__57144 = (function (){var G__57145 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__57145) : zprint.zutil.edn_STAR_.call(null,G__57145));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__57141,G__57142,G__57143,G__57144) : zprint.core.process_multiple_forms.call(null,G__57141,G__57142,G__57143,G__57144));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__57151 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57151,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57151,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq57134){
var G__57135 = cljs.core.first(seq57134);
var seq57134__$1 = cljs.core.next(seq57134);
var G__57136 = cljs.core.first(seq57134__$1);
var seq57134__$2 = cljs.core.next(seq57134__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57135,G__57136,seq57134__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___57244 = arguments.length;
var i__4731__auto___57245 = (0);
while(true){
if((i__4731__auto___57245 < len__4730__auto___57244)){
args__4736__auto__.push((arguments[i__4731__auto___57245]));

var G__57246 = (i__4731__auto___57245 + (1));
i__4731__auto___57245 = G__57246;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq57157){
var G__57158 = cljs.core.first(seq57157);
var seq57157__$1 = cljs.core.next(seq57157);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57158,seq57157__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___57247 = arguments.length;
var i__4731__auto___57248 = (0);
while(true){
if((i__4731__auto___57248 < len__4730__auto___57247)){
args__4736__auto__.push((arguments[i__4731__auto___57248]));

var G__57249 = (i__4731__auto___57248 + (1));
i__4731__auto___57248 = G__57249;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq57159){
var G__57160 = cljs.core.first(seq57159);
var seq57159__$1 = cljs.core.next(seq57159);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57160,seq57159__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___57250 = arguments.length;
var i__4731__auto___57255 = (0);
while(true){
if((i__4731__auto___57255 < len__4730__auto___57250)){
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq57161){
var G__57162 = cljs.core.first(seq57161);
var seq57161__$1 = cljs.core.next(seq57161);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57162,seq57161__$1);
});
...
var G__57263 = (i__4731__auto___57260 + (1));
i__4731__auto___57260 = G__57263;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq57165){
var G__57166 = cljs.core.first(seq57165);
var seq57165__$1 = cljs.core.next(seq57165);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57166,seq57165__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__57176,form){
var vec__57177 = p__57176;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57177,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57177,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57177,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57177,(3),null);
...
var vec__57182 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57182,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57182,(1),null);
...
var forms = (function (){var G__57202 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__57202) : zprint.zutil.edn_STAR_.call(null,G__57202));
})();
