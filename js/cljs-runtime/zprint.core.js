...
var vec__57423 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__57426 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57426,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57426,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57423,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57423,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__57431){
var vec__57432 = p__57431;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57432,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57432,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57435,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57435,(1),null);
...
var vec__57442 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57442,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57442,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57442,(2),null);
var vec__57445 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__57460){
var vec__57461 = p__57460;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57461,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57461,(1),null);
...
var len__4730__auto___57589 = arguments.length;
var i__4731__auto___57590 = (0);
while(true){
if((i__4731__auto___57590 < len__4730__auto___57589)){
args__4736__auto__.push((arguments[i__4731__auto___57590]));

var G__57591 = (i__4731__auto___57590 + (1));
i__4731__auto___57590 = G__57591;
continue;
} else {
}
break;
...
var vec__57470 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57470,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57470,(1),null);
...
var G__57474 = zprint.core.parse_string_all_options(rest_options);
var G__57475 = zprint.core.czprint_str_internal;
var G__57476 = ":parse-string-all? call";
var G__57477 = (function (){var G__57480 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__57480) : zprint.zutil.edn_STAR_.call(null,G__57480));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__57474,G__57475,G__57476,G__57477) : zprint.core.process_multiple_forms.call(null,G__57474,G__57475,G__57476,G__57477));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__57484 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57484,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57484,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq57466){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57467,G__57468,seq57466__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___57594 = arguments.length;
var i__4731__auto___57595 = (0);
while(true){
if((i__4731__auto___57595 < len__4730__auto___57594)){
args__4736__auto__.push((arguments[i__4731__auto___57595]));

var G__57596 = (i__4731__auto___57595 + (1));
i__4731__auto___57595 = G__57596;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq57496){
var G__57497 = cljs.core.first(seq57496);
var seq57496__$1 = cljs.core.next(seq57496);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57497,seq57496__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___57597 = arguments.length;
var i__4731__auto___57598 = (0);
while(true){
if((i__4731__auto___57598 < len__4730__auto___57597)){
args__4736__auto__.push((arguments[i__4731__auto___57598]));

var G__57599 = (i__4731__auto___57598 + (1));
i__4731__auto___57598 = G__57599;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq57502){
var G__57503 = cljs.core.first(seq57502);
var seq57502__$1 = cljs.core.next(seq57502);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57503,seq57502__$1);
});
...
args__4736__auto__.push((arguments[i__4731__auto___57601]));
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq57507){
var G__57508 = cljs.core.first(seq57507);
var seq57507__$1 = cljs.core.next(seq57507);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57508,seq57507__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___57603 = arguments.length;
var i__4731__auto___57604 = (0);
while(true){
if((i__4731__auto___57604 < len__4730__auto___57603)){
args__4736__auto__.push((arguments[i__4731__auto___57604]));

var G__57605 = (i__4731__auto___57604 + (1));
i__4731__auto___57604 = G__57605;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq57511){
var G__57512 = cljs.core.first(seq57511);
var seq57511__$1 = cljs.core.next(seq57511);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57512,seq57511__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__57531,form){
var vec__57532 = p__57531;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57532,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57532,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57532,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57532,(3),null);
...
var vec__57535 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57535,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57535,(1),null);
...
var forms = (function (){var G__57574 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__57574) : zprint.zutil.edn_STAR_.call(null,G__57574));
})();
