...
body_index_calculator.components.dash.status_icon = (function body_index_calculator$components$dash$status_icon(p__69598){
...
var done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69599__$1,new cljs.core.Keyword(null,"done?","done?",-1847001718),false);
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69599__$1,new cljs.core.Keyword(null,"label","label",1718410804));
...
var res = (function (){var G__69601 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("body-index-calculator.subscriptions","result","body-index-calculator.subscriptions/result",-1330365021)], null);
...
return (function body_index_calculator$components$dash$dash_$_iter__69605(s__69606){
return (new cljs.core.LazySeq(null,((function (res){
return (function (){
var s__69606__$1 = s__69606;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__69606__$1);
if(temp__5735__auto__){
var s__69606__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__69606__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__69606__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__69608 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__69607 = (0);
while(true){
if((i__69607 < size__4522__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__69607);
cljs.core.chunk_append(b__69608,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [body_index_calculator.components.dash.status_icon,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"done?","done?",-1847001718),(!((new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(x) == null))),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"abbr","abbr",2088591884).cljs$core$IFn$_invoke$arity$1(x)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["name-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(x))].join('')], null)));

var G__69631 = (i__69607 + (1));
i__69607 = G__69631;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__69608),body_index_calculator$components$dash$dash_$_iter__69605(cljs.core.chunk_rest(s__69606__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__69608),null);
}
} else {
var x = cljs.core.first(s__69606__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [body_index_calculator.components.dash.status_icon,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"done?","done?",-1847001718),(!((new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(x) == null))),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"abbr","abbr",2088591884).cljs$core$IFn$_invoke$arity$1(x)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["name-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(x))].join('')], null)),body_index_calculator$components$dash$dash_$_iter__69605(cljs.core.rest(s__69606__$2)));
}
} else {
return null;
}
