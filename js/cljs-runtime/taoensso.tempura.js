 ...
 */
taoensso.tempura.get_default_resource_compiler = taoensso.encore.memoize_((function (p__68888){
...
var escape_html_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68889__$1,new cljs.core.Keyword(null,"escape-html?","escape-html?",-397605100));
...
return taoensso.encore.memoize_(((function (esc1,esc2,map__68889,map__68889__$1,escape_html_QMARK_){
return (function (res){
...
return taoensso.tempura.impl.vec__GT_vargs_fn.cljs$core$IFn$_invoke$arity$1((function (){var G__68891 = taoensso.tempura.impl.vec_explode_args_in_strs(taoensso.tempura.impl.vec_explode_styles_in_strs.cljs$core$IFn$_invoke$arity$1(taoensso.tempura.impl.vec__GT_vtag(res)));
return (esc2.cljs$core$IFn$_invoke$arity$1 ? esc2.cljs$core$IFn$_invoke$arity$1(G__68891) : esc2.call(null,G__68891));
})());
} else {
...
});})(esc1,esc2,map__68889,map__68889__$1,escape_html_QMARK_))
);
}));
...
}),new cljs.core.Keyword(null,"cache-dict?","cache-dict?",2012653536),true,new cljs.core.Keyword(null,"cache-locales?","cache-locales?",-2101196885),true,new cljs.core.Keyword(null,"cache-resources?","cache-resources?",-247492358),false,new cljs.core.Keyword(null,"resource-compiler","resource-compiler",579506905),(function (){var G__68895 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"escape-html?","escape-html?",-397605100),false], null);
return (taoensso.tempura.get_default_resource_compiler.cljs$core$IFn$_invoke$arity$1 ? taoensso.tempura.get_default_resource_compiler.cljs$core$IFn$_invoke$arity$1(G__68895) : taoensso.tempura.get_default_resource_compiler.call(null,G__68895));
...
var vec__68900 = p__68898;
var arg1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68900,(0),null);
var arg2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68900,(1),null);
...
var merge_into_default_opts_68939 = taoensso.tempura.merge_into_default_opts;
var scoped_68940 = taoensso.tempura.scoped;
var search_resids_STAR__68941 = taoensso.tempura.search_resids_STAR_;
var search_resids_STAR__cached_68942 = taoensso.tempura.search_resids_STAR__cached;
var search_resids_68943 = taoensso.tempura.search_resids;
/**
 ...
 *                         ; resource ids.
 */
taoensso.tempura.tr = ((function (merge_into_default_opts_68939,scoped_68940,search_resids_STAR__68941,search_resids_STAR__cached_68942,search_resids_68943){
...
});})(merge_into_default_opts_68939,scoped_68940,search_resids_STAR__68941,search_resids_STAR__cached_68942,search_resids_68943))
;

taoensso.tempura.tr.cljs$core$IFn$_invoke$arity$3 = ((function (merge_into_default_opts_68939,scoped_68940,search_resids_STAR__68941,search_resids_STAR__cached_68942,search_resids_68943){
...
taoensso.tempura.tr.cljs$core$IFn$_invoke$arity$4 = ((function (merge_into_default_opts_68939,scoped_68940,search_resids_STAR__68941,search_resids_STAR__cached_68942,search_resids_68943){
return (function (opts,locales,resource_ids,resource_args){
var e_68945 = (function (){try{if(cljs.core.vector_QMARK_(resource_ids)){
return null;
} else {
...
taoensso.truss.impl._invar_violation_BANG_(true,"taoensso.tempura",262,"(vector? resource-ids)",resource_ids,e_68945,null);
}

if(cljs.core.seq(resource_ids)){
var opts__$1 = (merge_into_default_opts_68939.cljs$core$IFn$_invoke$arity$2 ? merge_into_default_opts_68939.cljs$core$IFn$_invoke$arity$2(opts,taoensso.tempura._STAR_tr_opts_STAR_) : merge_into_default_opts_68939.call(null,opts,taoensso.tempura._STAR_tr_opts_STAR_));
var map__68916 = opts__$1;
...
var default_locale = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68916__$1,new cljs.core.Keyword(null,"default-locale","default-locale",-677515761));
var dict = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68916__$1,new cljs.core.Keyword(null,"dict","dict",-1629964473));
var scope_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68916__$1,new cljs.core.Keyword(null,"scope-fn","scope-fn",-1139485860));
var cache_dict_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68916__$1,new cljs.core.Keyword(null,"cache-dict?","cache-dict?",2012653536));
var cache_locales_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68916__$1,new cljs.core.Keyword(null,"cache-locales?","cache-locales?",-2101196885));
var cache_resources_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68916__$1,new cljs.core.Keyword(null,"cache-resources?","cache-resources?",-247492358));
...
}catch (e68918){if((e68918 instanceof Error)){
var e = e68918;
return e;
} else {
throw e68918;
...
var locale_splits = (function (){var G__68919 = cache_locales_QMARK_;
var G__68920 = taoensso.encore.conj_some.cljs$core$IFn$_invoke$arity$2(locales__$1,default_locale);
return (taoensso.tempura.impl.expand_locales.cljs$core$IFn$_invoke$arity$2 ? taoensso.tempura.impl.expand_locales.cljs$core$IFn$_invoke$arity$2(G__68919,G__68920) : taoensso.tempura.impl.expand_locales.call(null,G__68919,G__68920));
})();
...
var _QMARK_matching_resource = (function (){var or__4131__auto__ = ((cljs.core.seq(resource_ids__$1))?(search_resids_68943.cljs$core$IFn$_invoke$arity$5 ? search_resids_68943.cljs$core$IFn$_invoke$arity$5(cache_resources_QMARK_,dict__$1,locale_splits,resid_scope,resource_ids__$1) : search_resids_68943.call(null,cache_resources_QMARK_,dict__$1,locale_splits,resid_scope,resource_ids__$1)):null);
...
var G__68922 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"opts","opts",155075701),opts__$1,new cljs.core.Keyword(null,"locales","locales",1785635955),locales__$1,new cljs.core.Keyword(null,"resource-ids","resource-ids",709857638),resource_ids__$1,new cljs.core.Keyword(null,"resource-args","resource-args",-1316782806),resource_args], null);
return (mrf.cljs$core$IFn$_invoke$arity$1 ? mrf.cljs$core$IFn$_invoke$arity$1(G__68922) : mrf.call(null,G__68922));
} else {
return null;
}
})();
...
var G__68923 = cache_resources_QMARK_;
var G__68924 = dict__$1;
var G__68925 = locale_splits;
var G__68926 = null;
var G__68927 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"missing","missing",362507769)], null);
return (search_resids_68943.cljs$core$IFn$_invoke$arity$5 ? search_resids_68943.cljs$core$IFn$_invoke$arity$5(G__68923,G__68924,G__68925,G__68926,G__68927) : search_resids_68943.call(null,G__68923,G__68924,G__68925,G__68926,G__68927));
}
}
}
})();
...
var fexpr__68928 = (resource_compiler.cljs$core$IFn$_invoke$arity$1 ? resource_compiler.cljs$core$IFn$_invoke$arity$1(r) : resource_compiler.call(null,r));
return (fexpr__68928.cljs$core$IFn$_invoke$arity$1 ? fexpr__68928.cljs$core$IFn$_invoke$arity$1(vargs) : fexpr__68928.call(null,vargs));
} else {
return null;
}
} else {
